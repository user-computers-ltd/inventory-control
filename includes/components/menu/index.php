    ...
    <?php if (defined(MENU_DIRECTORY)) : ?>
      <div id="menu-wrapper" class="web-only">
        ...
        <div id="sidebar">
          ...
          <a class="menu-item" href="<?php echo $menuDirectory; ?>">Main Menu</a>
          <?php
            foreach ($menuItems as $menuItem) {
              if (is_array($menuItem)) {
                ...
                foreach ($menuItem["sub"] as $subMenuItem) {
                  echo "<a class=\"menu-item sub\" href=\"" . BASE_URL . "$menuDirectory/$name/$subMenuItem\">$subMenuItem</a>";
                }
                echo "</div>";
              } else {
                echo "<a class=\"menu-item\" href=\"" . BASE_URL . "$menuDirectory/$menuItem\">$menuItem</a>";
              }
            }
          ?>
        </div>
