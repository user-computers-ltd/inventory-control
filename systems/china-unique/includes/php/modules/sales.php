<?php
  ...
  define("SALES_ALLOTMENT_PROVISIONAL_REPORT_MODEL_TITLE", "(F5a) Provisional Allotment Report By Client");
  define("SALES_ALLOTMENT_PROVISIONAL_REPORT_CUSTOMER_TITLE", "(F5b) Provisional Allotment Report By Client");
  ...
  define("SALES_DELIVERY_ORDER_PROVISIONAL_SAVED_TITLE", "(F6a) Provisional Sales Delivery Orders");
  ...
  $SALES_MODULE = array(
    ...
    SALES_ALLOTMENT_TITLE => array(
      SALES_ALLOTMENT_PROVISIONAL_INCOMING_TITLE  => "",
    ...
    SALES_ALLOTMENT_REPORT_TITLE => array(
      SALES_ALLOTMENT_PROVISIONAL_REPORT_MODEL_TITLE      => "",
      SALES_ALLOTMENT_PROVISIONAL_REPORT_CUSTOMER_TITLE   => "",
    ...
    SALES_DELIVERY_ORDER_TITLE => array(
      SALES_DELIVERY_ORDER_PROVISIONAL_SAVED_TITLE        => "",
