<?php
  ...
  define("SALES_ALLOTMENT_REPORT_PROVISIONAL_CUSTOMER_URL", SALES_ALLOTMENT_REPORT_URL . "provisional-client/");
  ...
  define("SALES_DELIVERY_ORDER_PROVISIONAL_URL", SALES_DELIVERY_ORDER_URL . "provisional/");
  ...
  define("SALES_ALLOTMENT_REPORT_PROVISIONAL_MODEL_TITLE", "(F5a) Provisional Allotment Report By Client");
  define("SALES_ALLOTMENT_REPORT_PROVISIONAL_CUSTOMER_TITLE", "(F5b) Provisional Allotment Report By Client");
  ...
  define("SALES_DELIVERY_ORDER_PROVISIONAL_TITLE", "(F6a) Provisional Sales Delivery Orders");
  ...
  $SALES_MODULE = array(
    ...
    SALES_ALLOTMENT_REPORT_TITLE => array(
      SALES_ALLOTMENT_REPORT_PROVISIONAL_MODEL_TITLE      => "",
      SALES_ALLOTMENT_REPORT_PROVISIONAL_CUSTOMER_TITLE   => SALES_ALLOTMENT_REPORT_PROVISIONAL_CUSTOMER_URL,
    ...
    SALES_DELIVERY_ORDER_TITLE => array(
      SALES_DELIVERY_ORDER_PROVISIONAL_TITLE              => SALES_DELIVERY_ORDER_PROVISIONAL_URL,
