<?php
  ...
  define("STOCK_IN_CREATE_TITLE", "(C1a) Create Stock In Voucher");
  define("STOCK_IN_SAVED_TITLE", "(C1b) Saved Stock In Vouchers");
  define("STOCK_IN_POSTED_TITLE", "(C1c) Posted Stock In Vouchers");
