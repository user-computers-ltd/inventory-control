<?php
  ...
  define("PURCHASE_REPLENISHMENT_SAVED_TITLE", "(E1b) Saved Replenishment Forms");
  ...
  define("PURCHASE_TRANSFER_TO_AP_TITLE", "(E6) Transfer To A/P");
  ...
  $PURCHASE_MODULE = array(
    PURCHASE_REPLENISHMENT_TITLE => array(
      PURCHASE_REPLENISHMENT_CREATE_TITLE => "http://www.lsmbv.com.hk:8000/idb/cu_inventory/si/rep_po/add.php",
      PURCHASE_REPLENISHMENT_SAVED_TITLE => "http://www.lsmbv.com.hk:8000/idb/cu_inventory/si/rep_po/list_saved.php"
    ),
    PURCHASE_ORDER_TITLE => array(
      PURCHASE_ORDER_POSTED_TITLE => "http://www.lsmbv.com.hk:8000/idb/cu_inventory/si/po/print_list_saved.php",
      PURCHASE_HISTORY_LOG_TITLE => "http://www.lsmbv.com.hk:8000/idb/cu_inventory/si/po/po_log.htm"
    ),
    ...
    PURCHASE_INCOMING_ADVICE_TITLE => array(
      PURCHASE_INCOMING_ADVICE_CREATE_TITLE => "http://www.lsmbv.com.hk:8000/idb/cu_inventory/si/ia/add.php",
      PURCHASE_INCOMING_ADVICE_SAVED_TITLE => "http://www.lsmbv.com.hk:8000/idb/cu_inventory/si/ia/list_saved_ia.php",
      PURCHASE_INCOMING_ADVICE_DO_TITLE =>  "http://www.lsmbv.com.hk:8000/idb/cu_inventory/si/ia/list_saved_ia_3.php",
      PURCHASE_INCOMING_ADVICE_POSTED_TITLE =>  "http://www.lsmbv.com.hk:8000/idb/cu_inventory/si/ia/list_posted_ia.php"
    ),
    PURCHASE_MONTHLY_REPORT_TITLE => "http://www.lsmbv.com.hk:8000/idb/cu_inventory/si/ia/pending_report.htm",
    PURCHASE_TRANSFER_TO_AP_TITLE => ""
