      ...
      <?php if (assigned($stockOutNo)): ?>
        <form id="stock-out-form" method="post">
          <table id="stock-out-header">
            ...
            <tr class="option-row">
              <td>Client:</td>
              <td>
                <select id="debtor-code" class="option-field" name="debtor_code" required>
                  <?php
        ...
        <script>
              ...
              rowInnerHTML +=
                ...
                + "<td>"
                  + "<input "
                    ...
                    + "min=\"0\" "
                    + "name=\"price[]\" "
                    + "value=\"" + stockOutModel["price"].toFixed(2) + "\" "
          ...
          function onModelNoChange(event, index) {
            ...
            if (matchedModel && stockOutModels[index]["model_no"] !== newModelNo) {
