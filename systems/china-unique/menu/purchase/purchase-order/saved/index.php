...
<html lang="en">
  ...
  <body>
    ...
    <div class="page-wrapper">
      ...
      <div class="headline"><?php echo PURCHASE_ORDER_SAVED_TITLE; ?></div>
      <form>
            ...
            <tbody>
              <?php
                ...
                for ($i = 0; $i < count($poHeaders); $i++) {
                  ...
                  echo "
                    <tr>
                      <td class=\"web-only\"><input type=\"checkbox\" name=\"po_id[]\" value=\"$id\" /></td>
                      <td title=\"$date\">$date</td>
                      <td title=\"$poNo\"><a class=\"link\" href=\"" . PURCHASE_ORDER_URL . "?id=$id\">$poNo</a></td>
